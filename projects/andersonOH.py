...
if __name__ == '__main__':
	...
	# create pokemon
	Charizard = Pokemon('Charmander', 'fire', ['FlameThrower','Fly', 'Blast Burn', 'Fire Punch'] , {'ATTACK': 100, 'DEFENSE': 80})

	
	Blastoise = Pokemon('squirtle', 'water', ['Water Gun', 'BubleBeam', 'Hydro Pump', 'Surf'] , {'ATTACK': 90, 'DEFENSE': 100})

	Bulbasuar = Pokemon('Bulbasuar', 'grass', ['Vine Whip', 'Razor Leaf', 'Earthquake', 'Grass Poison'] , {'ATTACK': 75, 'DEFENSE': 120})
